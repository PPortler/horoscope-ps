function FormSection() {
  return (
    <section id="form-section" className="mx-auto max-w-[600px] lg:w-full pb-10 lg:pb-0">
      ...
      {/* Input */}
      <div className="backdrop-blur-xl bg-black/70 border border-[#a88866] rounded-2xl px-6 py-4 shadow">
        <textarea
          style={{ resize: "none" }}
      ...
      <div className="mt-5 flex gap-3 justify-center text-sm lg:text-md">
        <button className="w-40 px-4 py-2 bg-[#526d2d] text-stone-100 font-medium rounded-3xl shadow border-4 border-[#ccb297] cursor-pointer hover:opacity-95 transition">
          เริ่มเลือกไพ่
        </button>
        <button className="w-40 px-4 py-2 bg-[#a88b61] text-stone-100 font-medium rounded-3xl shadow border-4 border-[#ccb297] cursor-pointer hover:opacity-95 transition">
          ข้าม
        </button>
      </div>
    </section>
