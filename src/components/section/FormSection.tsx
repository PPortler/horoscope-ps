    ...
    <section id="form-section" className="mx-auto max-w-[600px] lg:w-full pb-10 lg:pb-0">
      ...
      <div className="mt-5 flex gap-3 justify-center text-sm lg:text-md">
        <motion.button
          ...
          animate="visible"
          whileHover={{ y: -4 }}
          className="w-40 px-4 py-2 bg-[#526d2d] text-stone-100 font-medium rounded-3xl shadow border-4 border-[#ccb297] cursor-pointer "
        >
          เริ่มเลือกไพ่
        </motion.button>
        <motion.button
          ...
          animate="visible"
          whileHover={{ y: -4 }}
          className="w-40 px-4 py-2 bg-[#a88b61] text-stone-100 font-medium rounded-3xl shadow border-4 border-[#ccb297] cursor-pointer"
        >
          ข้าม
        </motion.button>
      </div>
